...
const cardItems = [
    ...
    price:'10,000.90', formerPrice:'20,000.90', bestPrice: false, id: 1},

    {productName:'Sony Headset, EPX5', src: headPhone , info:'HD sound', 
    price:'10,000.90', formerPrice:'20,000.90', bestPrice: true, id: 2},

    {productName:'Curology, full set', src:curology , info:'soft and clean', 
    price:'15,00.90', formerPrice:'20,000.90', bestPrice: true, id: 3},
    ...
    imgStyle:{backgroundColor:"none", width:"100%", bestPrice: true, id: 4}
    },

    {productName:'Yo Face Cap', src:facecap , info:'Long lasting', 
    price:'10,000.90', formerPrice:'20,000.90', bestPrice: false, id: 5},

    {productName:'Smartphone', src:smartphone, info:'Long lasting', 
    price:'10,000.90', formerPrice:'20,000.90', bestPrice: true, id: 6},

    {productName:'Yo Game Pad, Fullset', src:controller, info:'Soft and clean', 
    price:'15,000.90', formerPrice:'20,000.90', bestPrice: true, id: 7}, 

    {
      productName: 'Yo airpods, flixable', src:airpods, info:'Long Lasting', 
    price:'15,000.90', formerPrice:'20,000.90',bestPrice: true, id: 8
    },

    {productName:'Blue Sneakers, Flexible', src:bluesneakers , info:'Long Lasting', 
    price:'10,000.90', formerPrice:'20,000.90', bestPrice: true, id: 9
    },

    {productName:'The Sneakers, Flexible', src:item1 , info:'Long Lasting', 
    price:'10,000.90', formerPrice:'20,000.90', bestPrice: true, id: 10
    },

    {
      productName: 'Airpods, flixable', src:airpods, info:'Long Lasting', 
    price:'15,000.90', formerPrice:'20,000.90',bestPrice: true,id: 11
    },
